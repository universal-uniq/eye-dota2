...
- **Прокси** — Cloudflare Worker `eye-dota2-proxy.human001user.workers.dev`
  обходит CORS для `api.steampowered.com`.
...
- Иконки героев, предметов — CDN Valve.
- Иконки рангов — `raw.githubusercontent.com/odota/dotaconstants/master/build/ranks/<N>.png`.

## Ограничения

- У Valve нет публичного REST API со статусом игровых серверов Dota 2 по регионам.
- Без API-ключа OpenDota лимит 60 запросов/мин на IP.
- Cloudflare Worker бесплатно до 100 000 запросов в день.
